...
<body>
	<div class="container">
		<div class="col-md-offset-2 col-md-7">
			<h2 class="text-center">Delete Student By Id</h2>
			<div class="panel panel-info">
				<div class="panel-body">
					<form:form action="deleteStudentById" cssClass="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-md-offset-3 col-md-9">
								<form:button cssClass="btn btn-primary" onclick="if (!(confirm('Are you sure you want to delete this student?'))) return false">Delete Student</form:button>
							</div>
						</div>
						<div class="panel-body">
